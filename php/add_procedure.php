...
//----------------------------------form-----------------------------------
	...
	echo"<table>";
	echo'<form method="post" action="add_procedure.php" enctype="multipart/form-data">';
	echo"<tr><th><u>ADD PROCEDURE</u><br><br></th></tr>";
	echo "<tr><td>Procedure</td><td>:</td><td><input name='document' type='file' id='document' /></td></tr>";
