...
//----------------------------------form-----------------------------------
	...
	echo"<table>";
	echo'<form method="post" action="add_policy.php" enctype="multipart/form-data">';
	echo"<tr><th><u>ADD POLICY</u><br><br></th></tr>";
	echo "<tr><td>Policy</td><td>:</td><td><input name='document' type='file' id='document' /></td></tr>";
