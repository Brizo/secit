...
//----------------------------------form-----------------------------------
	...
	echo"<table>";
	echo'<form method="post" action="add_manual.php" enctype="multipart/form-data">';
	echo"<tr><th><u>ADD MANUAL</u><br><br></th></tr>";
	echo "<tr><td>Manual</td><td>:</td><td><input name='document' type='file' id='document' /></td></tr>";
