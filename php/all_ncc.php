...
?>
    <div id="part_2">
      ...
      <h3>COMPUTERS ON RECORD</h3>
       <div class="col_w1024">
           <div class="fp_service_box fp_c1"> 
     		<table cellspacing="20">
 		<?php
		  $result = mysql_query("SELECT pc_user, pc_ip, pc_desc, pc_state FROM computers WHERE pc_subnet = '147.110.184.0'");
		  echo "<table>";
		  echo "<tr>";
	...
	<article class="cols">
	<p><a href='../php/update_net2.php'><i>Update</i></a></p>  
	</article>	 
